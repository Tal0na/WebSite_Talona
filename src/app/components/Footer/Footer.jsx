...
const Footer = () => {
  return (
    <>
      <footer className="bg-gruvbox-light-bg dark:bg-gruvbox-bg border-t border-gruvbox-light-border dark:border-gruvbox-border">
        <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
          <a className="flex title-font font-medium items-center md:justify-start justify-center">
            <LogoComponent />
          </a>
          <p className="text-sm sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gruvbox-light-border dark:sm:border-gruvbox-border sm:py-2 sm:mt-0 mt-4">
