  ...
  return (
    <section className="body-font mt-24 relative text-black dark:text-white text-sm">
      ...
      <div className="container mx-auto flex px-5 py-24">
        ...
        >
          <h2 className="title-font mb-1 text-lg font-medium text-purple-400 dark:text-purple-300">
            Me Chame
          </h2>
          ...
          >
            <div className="relative mb-4">
              ...
              <input
                ...
                id="name"
                name="name"
                className="w-full rounded border border-purple-400 dark:border-purple-300 
                ...
                focus:border-purple-400 focus:ring-1
            ...
            <div className="relative mb-4">
              ...
              <input
                ...
                id="email"
                name="email"
                className="w-full rounded border border-purple-400 dark:border-purple-300 bg-zinc-100 dark:bg-black 
                py-1 text-base leading-8 
                text-gray-100 outline-none transition-colors duration-200 ease-in-out focus:border-purple-400 focus:ring-1 
                focus:ring-purple-500"
                value={email}
