    ...
    <>
      <div className="bg-white dark:bg-black">
        <div className="flex flex-col sm:pl-8 md:pl-16 lg:pl-32 xl:mt-8 xl:pl-48 ">
          <h3 className="mt-40 h-6 pl-10 text-xl text-black dark:text-white">
            Oi, Meu Nome é!
          </h3>
         ...
         text-zinc-600 dark:text-zinc-300"
          ...
          <div className="flex justify-start pb-32 pl-12">
            <a
              ...
              className="my-4 rounded-md bg-purple-700 px-6 py-3 text-center text-lg 
            font-medium text-white transition 
            duration-300 hover:bg-purple-600 dark:text-black"
            >
              Meu Portfólio!
            </a>
          </div>
