...
export default function Links() {
  return (
    <div>
      <Navbar />
      <h1 className="mt-10 text-center text-3xl text-purple-r">Meus Links</h1>
      ...
      <div id="links" className="mx-auto max-w-[675px]">
        <a
          className="link rounded-10 text-decoration-none tap-highlight-transparent mx-10 my-3 block transform rounded-lg border-2 bg-transparent p-2 text-center font-roboto text-lg transition-transform duration-300 hover:scale-105"
