  ...
  return (
    <div className="min-h-screen w-full bg-white dark:bg-black">
      ...
      <div id="links" className="mx-auto max-w-[675px]">
        ...
        <Link
          className="link rounded-10 text-decoration-none tap-highlight-transparent  font-roboto mx-10 my-3 block transform rounded-lg
          border-2 border-black p-2 text-center text-lg text-black shadow-md shadow-zinc-300 transition-transform duration-300 hover:scale-105 hover:bg-zinc-600 
