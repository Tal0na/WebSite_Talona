  ...
  return (
    <div className="min-h-screen w-full dark:bg-[#121212] bg-[] font-indie">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <h1 className="text-3xl font-bold text-center dark:text-rose-500 text-rose-600 mb-10">
...
const ProjectCard = ({ title, description, link, icon }) => {
  return (
    <div className="bg-white dark:bg-black rounded-xl shadow-md p-6 flex flex-col items-center justify-center">
      <FontAwesomeIcon
        icon={icon}
        className="text-lg mb-2 dark:text-rose-500 text-rose-600"
      />
      <h2 className="text-lg font-bold text-center mb-2">{title}</h2>
      <p className="text-sm text-center">{description}</p>
      <Link href={link} passHref>
        <div
          className="mt-4 dark:bg-rose-500 bg-rose-600 text-white dark:text-black px-4 py-2 rounded-full inline-block 
